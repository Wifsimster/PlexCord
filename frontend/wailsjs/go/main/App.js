...
export function CanSelfUpdate() {
  return window['go']['main']['App']['CanSelfUpdate']();
}
...
export function ClearListeningHistory() {
  return window['go']['main']['App']['ClearListeningHistory']();
}
...
export function GetAutoUpdateCheck() {
  return window['go']['main']['App']['GetAutoUpdateCheck']();
}
...
export function GetListeningHistory(arg1) {
  return window['go']['main']['App']['GetListeningHistory'](arg1);
}

export function GetListeningStats() {
  return window['go']['main']['App']['GetListeningStats']();
}
