...
<template>
    <div class="card">
        ...
        <p class="text-lg mb-4">
            Sakai is an application template for Vue based on <URL href="https://github.com/vuejs/create-vue" class="font-medium text-primary hover:underline">create-vue</URL>, the recommended way to start a <strong>Vite-powered</strong> Vue
            project.
        </p>
