        ...
        <Card class="setup-wizard-card">
            ...
            <template #content>
                    ...
                    <StepPanels>
                        <StepPanel v-for="step in steps" :key="step.value" :value="step.value">
                            ...
                            <div class="navigation-buttons">
                                <Button v-if="showBackButton && step.value === activeStepValue" label="Back" icon="pi pi-arrow-left" severity="secondary" @click="goToPreviousStep" class="mr-2" />
                ...
                <div v-if="showSkipLink" class="text-center mt-3">
                    <a href="#" @click.prevent="skipSetup" class="text-surface-600 dark:text-surface-400 hover:text-primary-500 transition-colors" :class="{ 'pointer-events-none opacity-50': isSkipping }">
                        <small>
